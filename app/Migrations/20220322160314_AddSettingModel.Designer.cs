...
namespace backend.Migrations
{
    ...
    [Migration("20220322160314_AddSettingModel")]
            ...
            modelBuilder.Entity("backend.Models.Accounts.AdminModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "John",
                            LastName = "Admin",
                            Password = "$MYHASH$V1$10000$HwBWQkzs+jupwhHvNYpzV8xfg0bLz/midDQjkxDXRYQ6y/Ni"
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.Accounts.DoctorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "John",
                            LastName = "Doctor",
                            Password = "$MYHASH$V1$10000$DliiEII2gp5KY/vw0l311BFwSndF4aJ9EWbq9UpSL61XBUWQ"
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.Accounts.PatientModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "John",
                            LastName = "Patient",
                            Password = "$MYHASH$V1$10000$rapEF1Kim78mfT3sgThrQ5rqu6kuPi0wWZVM/x8ulOKAlgyV",
                            Pesel = "22222222222"
                        });
                });
